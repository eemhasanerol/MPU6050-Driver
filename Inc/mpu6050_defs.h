...
/* -------------------------------------------------------------------------- */
/** @defgroup MPU6050_SampleRate Output sample rate presets
 *  @{
 */
#define MPU6050_SMPLRT_1000HZ   (0x00U)   /*!< 1000 Hz */
#define MPU6050_SMPLRT_500HZ    (0x01U)   /*!< 500 Hz */
#define MPU6050_SMPLRT_250HZ    (0x03U)   /*!< 250 Hz */
#define MPU6050_SMPLRT_200HZ    (0x04U)   /*!< 200 Hz */
#define MPU6050_SMPLRT_100HZ    (0x09U)   /*!< 100 Hz */
#define MPU6050_SMPLRT_50HZ     (0x13U)   /*!< 50 Hz */
#define MPU6050_SMPLRT_20HZ     (0x32U)   /*!< 20 Hz */
#define MPU6050_SMPLRT_10HZ     (0x63U)   /*!< 10 Hz */
#define MPU6050_SMPLRT_5HZ      (0xC7U)   /*!< ~5 Hz */
/** @} */
